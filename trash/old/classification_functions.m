...
function IsBiellipticCanonical(K,g,psi)
    ...
    */
    ...
    J:=ideal<PolK|A>;
    I:=ideal<PolK|[PolK!f]>;
    J:=IdealQuotient(J,I);  // want f(a) ne 0
    J:=Radical(J);
...
function IsBiellipticHyperellipticWithoutModel(M : number_of_primes_to_consider:=70) //TODO 50 instead?
    /*  
...
function IsBielliptic(X)
    ...
    */
    ...
    for p in primes do
        ...
        is_bielliptic_P, proof, a1 :=IsBiellipticCanonical(FF,g,psi_P);
